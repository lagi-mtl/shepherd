...
class VisualizationUtils:
    ...
    @staticmethod
    def show_detections(image: np.ndarray, detections: List[Dict], 
        ...
        for det in detections:
            ...
            class_name = VisualizationUtils.YOLO_CLASSES.get(class_id, f"Class {class_id}")
            ...
            if show_labels or show_conf:
                ...
                cv2.putText(viz, label_text, (x1, y1-10), 
    ...
    @staticmethod
    def show_pipeline_step(step_name: str, image: np.ndarray, 
    ...
    def show_query_results(query_results: List[Dict], query_text: str):
        ...
        try:
            ...
            for i, result in enumerate(query_results):
                ...
                color = np.array([1.0, 1.0 - normalized_similarity, 1.0 - normalized_similarity])
                ...
                print(f"  Class: {VisualizationUtils.YOLO_CLASSES.get(int(float(metadata.get('class_id', 0))), 'Unknown')}")
